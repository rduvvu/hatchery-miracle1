...
export class LoginPage implements OnInit {
  ...
  constructor(public validations: ValidationsService, private fb: FormBuilder, private router: Router, private apiService: ApiServiceService, private alertController: AlertController) {
  }
  ...
  onLoginWithPassword() {
    ...
    this.apiService.postApi(apis.login, reqBody).subscribe({
